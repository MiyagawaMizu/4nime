...
const moviesSlide = document.querySelector('.movies_slide_main')
const movieSlide = document.querySelector('.movies_slide')
// moviesSlide.style.left = '-100px'
console.log([moviesSlide])

// ;(() => {
//     setInterval(() => {
//         if (moviesSlide.clientWidth + moviesSlide.offsetWidth > moviesSlide.offsetWidth) {
//             moviesSlide.clientWidth = 0
//         } else {
//             moviesSlide.clientWidth += movieSlide.offsetWidth
//         }
//     }, 1000)
// })()
